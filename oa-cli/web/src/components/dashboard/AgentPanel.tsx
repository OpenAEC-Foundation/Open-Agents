        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-black">
          <div className="flex items-center justify-between px-3 py-1.5 border-b border-neutral-800 bg-neutral-900/80">
            ...
            <button
              ...
              disabled={!outputText}
              className="flex items-center gap-1 text-[10px] text-neutral-500 hover:text-neutral-300 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
            >
          ...
          <div
            ref={outputRef}
            className="flex-1 overflow-auto p-3 font-mono text-xs text-green-400 leading-relaxed whitespace-pre-wrap"
          >
            {outputText || <span className="text-neutral-600">No output yet...</span>}
          </div>
        </div>
      )}
